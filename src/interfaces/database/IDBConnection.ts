import { CreateProject, CreateProjectSectionA, CreateProjectSectionB, CreateProjectSectionC, CreateProjectSectionD, CreateProjectSectionE, CreateReport, UpdateProject, UpdateReport } from "../../domain";
...
export abstract class ProjectConnection {
  ...
  abstract updateProject(query: UpdateProject): Promise<IProjectInterface>
  abstract getAllProjects(filter?:any): Promise<IProjectInterface>
  abstract getProjectById(id:string): Promise<IProjectInterface>
}
